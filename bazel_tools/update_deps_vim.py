"""
Created vim bindings by adding this to vimrc:
...
def _bazel_query(subject, query_options, workspace_root):
    return _check_output(["bazel", "query"] + query_options + [subject],
...
def _find_file_targets(relative_filename, workspace_root):
    """
...
def main():
    ...
    for target in targets:
        cmd = [
            '/mnt/flashblade/carden/utils/freshen_deps.py', '--remove_deps',
            target
        ]
